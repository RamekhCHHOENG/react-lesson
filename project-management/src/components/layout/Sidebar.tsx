...
export function Sidebar({ activeItem = "projects", onItemClick }: SidebarProps) {
 ...
 <aside
 className={cn(
 "flex flex-col h-full bg-muted/50 border-r transition-all duration-200 select-none",
 ...
 <div className="text-sm font-semibold text-foreground truncate">ProjectHub</div>
 ...
 className="flex items-center gap-3 w-full rounded px-2.5 py-2 text-sm font-medium text-muted-foreground hover:bg-accent hover:text-foreground transition-colors"
 >
 {collapsed ? (

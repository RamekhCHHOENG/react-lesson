...
function Calendar({
 ...
 selected:
 "bg-primary text-white hover:bg-primary/90 hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground rounded",
 today: "bg-primary/10 text-primary rounded font-semibold",
 outside:

...
export function DatePicker({
 ...
 type="button"
 className={cn(
 "flex h-9 w-full items-center justify-between rounded border bg-muted/50 px-3 py-1 text-sm text-foreground",
 "hover:bg-muted transition-all outline-none",
 "focus:border-ring focus:bg-background focus:shadow-[0_0_0_1px] focus:shadow-ring",

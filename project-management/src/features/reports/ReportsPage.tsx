      ...
      <div className="bg-card border-b shrink-0">
        <div className="px-6 py-4">
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center w-8 h-8 rounded bg-gradient-to-br from-destructive to-orange-500">
          ...
          <Card className="overflow-hidden">
            ...
            <CardContent className="p-0 pt-4">
              <div className="divide-y">
                {/* Table header */}
                <div className="grid grid-cols-[1fr_80px_80px_120px_60px] gap-4 px-5 py-2.5 bg-muted/30 text-[10px] font-semibold text-muted-foreground uppercase tracking-wider">
                  <span>Project</span>
